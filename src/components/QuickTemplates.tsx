    ...
    <div className="flex gap-2">
      {templates.map((t) => (
        <button
          ...
          className="flex-1 bg-warm-200 dark:bg-slate-600 text-slate-900 dark:text-white text-sm rounded-xl p-3 min-h-[44px] active:bg-warm-300 dark:active:bg-slate-500 font-bold"
        >
          {t.label}
        </button>
      ))}
